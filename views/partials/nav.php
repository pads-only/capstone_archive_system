...
<nav class="bg-white border-b border-gray-200">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="hidden md:flex space-x-2">
                    ...
                    <?php endif; ?>
                    <a href="/capstone" class="<?= parse_url($_SERVER['REQUEST_URI'])['path'] === '/capstone' || parse_url($_SERVER['REQUEST_URI'])['path'] === '/capstone/show' || parse_url($_SERVER['REQUEST_URI'])['path'] === '/capstone/create' || parse_url($_SERVER['REQUEST_URI'])['path'] === '/capstone/my_projects' || parse_url($_SERVER['REQUEST_URI'])['path'] === '/capstone/edit' || parse_url($_SERVER['REQUEST_URI'])['path'] === '/capstone/search' ? 'bg-blue-900 text-white' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-700' ?> px-3 py-2 rounded-md text-sm">Capstone</a>
    ...
    <div id="mobileMenu" class="hidden md:hidden bg-white border-t border-gray-200">
        <div class="px-4 py-3 space-y-1">
            ...
            <a href="/capstone" class="<?= parse_url($_SERVER['REQUEST_URI'])['path'] === '/capstone' || parse_url($_SERVER['REQUEST_URI'])['path'] === '/capstone/show' || parse_url($_SERVER['REQUEST_URI'])['path'] === '/capstone/create' || parse_url($_SERVER['REQUEST_URI'])['path'] === '/capstone/my_projects' || parse_url($_SERVER['REQUEST_URI'])['path'] === '/capstone/edit' || parse_url($_SERVER['REQUEST_URI'])['path'] === '/capstone/search' ? 'bg-blue-900 text-white ' : 'text-gray-600 hover:bg-blue-50' ?> block  px-3 py-2 rounded-md">Capstone</a>
